...
expect(html.includes('aria-label="Open Canada.ca CRS criteria for age"'), "officialLinks.ageAccessibleLink");
expect(html.includes('data-tooltip="Official Canada.ca CRS criteria"'), "officialLinks.tooltipText");
expect(html.includes(">ⓘ</a>"), "officialLinks.infoSymbol");
...
expect(css.includes(".factor-source-link::after"), "officialLinks.tooltipStyle");
